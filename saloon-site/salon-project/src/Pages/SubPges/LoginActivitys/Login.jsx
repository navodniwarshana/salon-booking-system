      ...
      <div className="block">
        <form className="space-y-4 mt-4 p-4 max-w-md mx-auto bg-black opacity-75 border-4 rounded-2xl md:border-black shadow-md">
          <div className="flex justify-between my-4 mx-5">
            <button>
              <FaAngleLeft onClick={() => handleClick("GoBack")}  className="w-8 h-8 border-2 bg-black border-white fill-white hover:fill-black hover:bg-white rounded-full" />
            </button>
            <h1 className="text-center font-playfir text-white font-bold text-2xl">
              Log In
            </h1>
            <button>
              <IoIosClose  onClick={() => handleClick("CloseWin")}   className="w-8 h-8 border-2 border-white bg-black fill-white hover:fill-black hover:bg-white rounded-full" />
            </button>
          </div>
          <div className="relative py-8">
            ...
            <div className="font-itim my-4">
              <label className="absolute text-white border-1 text-xl pl-6" htmlFor="">
                Password
              </label>
              <input
                className="shadow appearance-none border-2 border-black text-lg rounded-full w-full mt-8 pt-4 py-2 px-3 text-black placeholder-opacity-100 leading-tight focus:outline-none focus:shadow-outline"
              ...
              <div className="flex items-center justify-center text-center rounded-full p-1 my-8">
               ...
               <p onClick={() => handleClick("LoginTOProfile")}  className="bg-black cursor-pointer hover:bg-white text-white hover:text-black font-bold py-2 px-4 focus:outline-none focus:shadow-outline w-1/2 rounded-full border-2 border-white"
                type="button">
                    Log In
                </p>
              ...
              <div className="text-white text-center">
                  ...
                  <p onClick={() => handleClick("forgotPassword")}
                    className="m-2 text-lg hover:text-xl hover:font-bold active:underline">
                    Forgot Password
                  </p>
              
                <br />
                
                  <p onClick={() => handleClick("SignUp")}  
                  className="m-2 text-center text-lg hover:text-xl hover:font-bold active:underline">
                    Sign Up
                  </p>
